...
@section('content')
    ...
    @include('components.modals.message', [
        'title' => 'Export Emplois du temps',
        'content' => 'Exportez seulement le groupe sélectionné ou tous les groupes ?',
        'allGroupsText' => 'Tous les groupes',
        'selectedGroupText' => 'Groupe sélectionné:',
    ])
            ...
            <script>
                ...
                $("#progress-dialog").dialog({
                    ...
                    open: function() {
                        ...
                        var progressLabel = $(
                        ".progress-label"); // Replace .progress-label with the selector of your progress label element
                        ...
                        $("#progressbar").progressbar({
                            value: false,
                            change: function() {
                                progressLabel.text("Current Progress: " + $("#progressbar").progressbar(
                                    "value") + "%");
                            },
                            complete: function() {
                ...
                $('#export-excel').click(function() {
                    var zip = new JSZip();
                    // $('#container').addClass('bluryat');
                    $('#selectedGroupButton').text('Groupe sélectionné: ' + $('#Group-input').val());
                    $('.ui.modal').modal({
